...
A production-style developer infrastructure tool that acts as an HTTP and WebSocket proxy with latency simulation, observability, and failure injection.

It allows developers to route requests through a proxy to test API reliability, simulate network conditions, and observe request behavior.
